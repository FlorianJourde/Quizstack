...
function Sidebar(
    ...
    return (
        <div className={`xl:sticky top-spacing-primary z-10 -order-1 transition-all`}>
            <aside
                ...
                <div className="buttons-container xl:flex-col gap-2">
                    ...
                    {question.correctChoices && (
                        <button className="button button-action relative copy-link" data-url={`${window.location.origin}/question/${question.id}`}>
                            ...
                            <ul className="tags-container hidden absolute whitespace-nowrap top-0 left-1/2 -translate-x-1/2 -translate-y-full lg:top-1/2 lg:left-auto lg:right-0 lg:translate-x-full lg:-translate-y-1/2 z-10">
